...
image:user:sourcetree-installation-step-1.png[]
...
image:user:sourcetree-installation-step-2.png[]
...
Дательніше у статті xref:user:registry-admin-deploy-regulation.adoc[Розгортання регламенту реєстру]
...
image:user:sourcetree-installation-step-8.png[]

** Натисніть кнопку "Add"
image:user:sourcetree-installation-step-9.png[]
