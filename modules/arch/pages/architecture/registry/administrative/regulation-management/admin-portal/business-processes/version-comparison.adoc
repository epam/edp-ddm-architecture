...
image::architecture/registry/administrative/regulation-management/admin-portal/business-processes/bpmn-diff.png[]

=== Перегляд змін в задачі бізнес процеса

image::architecture/registry/administrative/regulation-management/admin-portal/business-processes/bpmn-diff-changes.png[]
