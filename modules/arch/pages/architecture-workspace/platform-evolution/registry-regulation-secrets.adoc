...
# External system used both by registry services and business processes - can be updated & can't be removed by "control-plane" administrator
  diia:
    ...
    auth:
      ...
      auth-uri: "/api/v1/auth/partner" # relative path to "url"
      external-auth-url: "https://api2t-auth.diia.gov.ua/api/v1/auth/partner" # overriding auth-uri for external auth server
    ...
    external-systems:
      diia:
        ...
        auth:
          ...
          external-auth-url: "https://api2t-auth.diia.gov.ua/api/v1/auth/partner" # overriding auth-uri for external auth server if any
          access-token-json-path: "$.token"
----
