...
** Файл з мапінгами для EDR моку __edr.json__
[source, json]
----
    {
        "mappings": [
...
** Файл відповіді __mock-integration/edr-response.xml__
[source, xml]
----
<soap11env:Envelope
...
** Файл відповіді __mock-integration/dia-post_info-response.json__
[source, json]
----
{
  "info": "string"
