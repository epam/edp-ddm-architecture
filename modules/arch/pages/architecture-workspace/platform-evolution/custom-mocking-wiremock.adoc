...
+++ <&file> <external_system_name>-<request_name>-response.json
+++ <&file> ...
++ ...
}
}
...
====
----
include::attachment$architecture-workspace/platform-evolution/mocking/dia-post_info-response.json[json]
----
====
