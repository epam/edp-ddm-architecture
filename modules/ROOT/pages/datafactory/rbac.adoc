...
Роль для користувача визначається на рівні Keycloak під час автентифікації й передається у JWT токені Lowcode'у. Кожен API запит Lowcode до Datafabric містить отриману з JWT токену роль.
