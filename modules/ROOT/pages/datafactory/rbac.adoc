...
----
include::ROOT:partial$datafactory/rbac_overview.puml[]
----
//====
...
----
include::ROOT:partial$datafactory/rbac_process.puml[]
----
//====
...
----
include::ROOT:partial$datafactory/rbac_change_permissions.puml[]
----
