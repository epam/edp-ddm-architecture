...
hasRole('officer') && hasRole('passport_officer') && hasRole('inn_officer')
[source]
----
PUT /person/{id}
{
...
hasRole('inn_officer') AND (hasAnyRole('officer') OR isAuthenticated())
...
hasRole('passport_officer') AND hasRole('officer')
[source]
----
