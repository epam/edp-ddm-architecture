...
* Якщо перейменувати назву дашборда кирилицею, то в URL ви отримаєте ідентифікатор дашборда та прочерк. Це може призвести до незручностей при використанні https://redash.io/help/user-guide/integrations-and-api/api[Redash API] у майбутньому.
+
