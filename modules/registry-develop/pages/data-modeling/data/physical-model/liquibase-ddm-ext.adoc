...
|=======================================================================
|Значення| Опис
|equal|визначає, чи є точна відповідність вказаному значенню
|startsWith|визначає, чи починається задане значення із зазначеного префікса
|contains|визначає, чи є точна або нечітка (менш точна) наявність збігів з вказаним значенням
|in|визначає, чи є точна відповідність заданого значення будь-якому значенню у масиві
|=======================================================================
