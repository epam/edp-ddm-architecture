...
= Інтеграція із зовнішніми сервісами за допомогою конектора REST

`REST Connector` -- це конектор для підключення до зовнішніх захищених сервісів поза кластером реєстру.
