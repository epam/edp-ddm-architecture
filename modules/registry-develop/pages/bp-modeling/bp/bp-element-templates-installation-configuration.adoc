...
[CAUTION]
====
Для того, щоб запустити бізнес-процес в цільовому реєстрі на Платформі, недостатньо просто використовувати делегат. Необхідно попередньо:
...
+
NOTE: Назва реєстру має відповідати назві, вказаній для реєстру в адміністративній панелі Control Plane.
