= Створення сценаріїв побудови фізичної моделі даних реєстру за допомогою функціональних розширень Liquibase
...
Liquibase підтримує як https://docs.liquibase.com/change-types/home.html[стандартні change types], так і xref:admin:liquibase-ddm-ext.adoc[додатково створені або розширені change types].
...
image::admin:lb-create-sc-xsd-diagram.png[]
...
image::admin:lb-many-to-many-xsd-diagram.png[]
...
image::admin:lb-create-type-enum-composite.png[]
...
image::admin:lb-create-type-domain.png[]
