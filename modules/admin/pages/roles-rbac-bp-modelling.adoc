...
TIP: _Керування доступом на основі ролей (англ. **Role Based Access Control, RBAC**) -- розвиток політики вибіркового керування доступом, при якому права доступу суб'єктів системи на об'єкти групуються з урахуванням специфіки їх застосування, утворюючи ролі._
...
- `data-model/role_permission.xml` -- для xref:roles-rbac-bp-modelling.adoc#access-rights-distribution-data-model[розмежування прав доступу на рівні моделі даних]
