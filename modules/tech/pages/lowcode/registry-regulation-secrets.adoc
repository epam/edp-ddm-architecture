...
[CAUTION]
Визначення налаштувань реєстру у якості клієнта Трембіти перемістити на рівень окремих інтеграцій! Необхідно актуалізувати UI-мокапи.
...
[CAUTION]
Визначення налаштувань реєстру у якості клієнта Трембіти перемістилось на рівень окремих інтеграцій! Необхідно актуалізувати UI-мокапи.
