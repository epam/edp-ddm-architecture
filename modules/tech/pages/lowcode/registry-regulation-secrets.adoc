...
|Дія
|Інформаційний обмін через інтеграційний конектор в рамках виконання бізнес-процесів

|<Зовнішня система>
|Інформаційний обмін через універсальний інтеграційний _REST_-конектор в рамках виконання бізнес-процесів
