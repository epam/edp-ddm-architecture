...
Наразі, ціллю дублювання є можливість визначення окремих мок-сервісів для реєстрів - необхідно змінити цей підхід.
--
...
spec:
  ...
  - find:
      name:
        regexp: "secret/<registry>/trembita-registries/" # multiple secrets matching key pattern
----
...
spec:
  ...
  - find:
      name:
        regexp: "secret/<registry/>external-systems/" # multiple secrets matching key pattern
  - find:
      tags:
        type: registry # secret metadata criteria
----
...
."AUTH_TOKEN" Vault Secret: "secret/<registry>/trembita-registries/<trembita-registry-name>"
[source, json]
----
{
...
."BASIC" Vault Secret: secret/<registry/>external-systems/<ext-system-name>
[source, json]
----
{
...
."BEARER" | "AUTH_TOKEN" | "AUTH_TOKEN+BEARER" Vault Secret: secret/<registry>/external-systems/<ext-system-name>
[source, json]
----
{
