== Низькорівневий дизайн сервісу повідомлень

За реалізацію вимог по формуванню та відправці повідомлень користувачам відповідає окремий компонент "_Сервіс повідомлень користувачів_".
