...
|Підтримка валідації вибраної schema
|Базовий функціонал відсутній, але є можливість створення кастомних сніпетів на xref:lowcode/admin-portal/data-model/xml-editor-tech-evaluation.adoc#Підтримка автодоповнення[прикладі автодоповнення]
...
[NOTE]
====
Перейти до xref:lowcode/admin-portal/data-model/xml-editor-tech-evaluation.adoc#Підтримка автодоповнення[документації]
====

== Синтаксичний аналіз
Для аналізу кода використовується https://developer.mozilla.org/docs/Web/API/DOMParser[DOMParser API] та https://microsoft.github.io/monaco-editor/api/modules/monaco.editor.html#setModelMarkers[Monaco Editor API]
