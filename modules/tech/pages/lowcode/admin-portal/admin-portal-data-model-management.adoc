= Редагування структури таблиць регламентів реєстрів з використанням адмінпорталу

include::data-model/admin-portal-data-model-problem-description.adoc[]

include::data-model/admin-portal-data-model-scenarious.adoc[]
...
image::lowcode/admin-portal/tables-management-luqibase-current-flow.svg[]
...
image::lowcode/admin-portal/tables-management-luqibase-extended-flow.svg[]
...
include::data-model/domain-model-description.adoc[]
include::data-model/domain-attributes-description.adoc[]

include::data-model/admin-portal-data-model-principles.adoc[]

== Опис технічного рішення
//=== System context
//image::lowcode/admin-portal/tables-management-c4-context.svg[]

=== Container
image::lowcode/admin-portal/tables-management-c4-container.svg[]

=== Admin portal API container
image::lowcode/admin-portal/tables-management-c4-apiContainer.svg[]

=== CICD container
image::lowcode/admin-portal/tables-management-c4-cicd-container.svg[]
...
image::lowcode/admin-portal/tables-management-component-structure.svg[]
