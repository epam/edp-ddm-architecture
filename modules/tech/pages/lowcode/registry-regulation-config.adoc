...
При оновленні існуючих реєстрів, необхідно розширити структуру регламенту відповідно до канонічного вигляду та створити _settings/settings.yml_ файл з налаштуваннями реєстру, як зазначено вище та виконати наступні дії:
