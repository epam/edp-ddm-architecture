...
[CAUTION]
На даний момент в регламенті присутній конфігураційний файл _<registry-regulation>/settings.xml_ з налаштуваннями Фабрики Даних. Розглянути доцільність його перевикористання.
