...
|_Конфігурація реєстру_
|*registry-configuration*
|Видалення налаштувань _themeFile_

|_Пайплайн публікації конфігурації реєстру_
|*control-plane-jenkins*
|Видалення застосування налаштувань _themeFile_ до аутентифікаторів
...
|*registry-jenkins*
|Розширення логіки публікації регламенту кроками налаштувань аутентифікаторів / реструктуризація ресурсів
...
|Валідація поштових адрес згідно переліку заблокованих доменів
