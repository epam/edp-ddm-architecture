...
=== Публікація налаштувань аутентифікаторів кабінетів

Необхідно змінити логіку _Пайплайну публікації регламенту_ таким чином, щоб налаштування _themeFile_ та _title_ для конфігурації реєстрових аутентифікаторів _dso-citizen-authenticator_ та _dso-officer-authenticator_ брались не з _registry-configuration.git_, а з регламенту _settings/settings.yml_.
