...
Для забезпечення можливостей збереження в _Об’єктне сховищe реєстру_ файлів, які було вивантажено з зовнішніх систем у процесі виконання бізнес-процесу, необхідно розширити набір типових розширень окремою _JUEL_-функцією, яка б дозволяла тимчасово зберегти цифровий документ для використання при формуванні запиту у _Фабрику Даних_ реєстру.
...
* _save_digital_document_from_url(URL sourceFileUrl, String targetFileName): DocumentMetadata_
...
[source,groovy]
----
def documentMetadata = save_digital_document_from_url(new URL("http://..."), "digital-document.ext") // Temporary save file to object storage
