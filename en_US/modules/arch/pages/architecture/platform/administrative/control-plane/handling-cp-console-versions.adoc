...
Якщо трафік збігається, він надсилається до поди відповідної версії адмін-консолі. В цьому випадку, критерієм відповідності буде слугувати
HTTP Request header.
...
=== План розробки
* Розширення функціональності адмін-консолі по управлінню заголовками версій, контролем версії реєстру та версії в header,
