...
При створенні wildcard шляху логіка призначення лімітів така, що специфічні ліміти мають перевагу над wildcard.
Тобто wildcard ліміт застосовується тоді і тільки тоді коли при створенні нової точки інтеграції з публічним доступом не було вказано специфічних лімітів.
