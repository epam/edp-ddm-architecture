...
image::architecture-workspace/platform-evolution/master-development/component.svg[]

.Діаграма діяльності. Створення сутності
image::architecture-workspace/platform-evolution/master-development/create-entity.svg[]

.Діаграма діяльності. Оновлення сутності
image::architecture-workspace/platform-evolution/master-development/update-entity.svg[]

.Діаграма діяльності. Видалення сутності
image::architecture-workspace/platform-evolution/master-development/delete-entity.svg[]
...
.Registry Regulator Manager
[%collapsible]
====
swagger::{attachmentsdir}/architecture-workspace/platform-evolution/master-development/rrm-swagger.yml[]
====
