...
|https://gerrit-mdtu-ddm-edp-cicd.apps.cicd2.mdtu-ddm.projects.epam.com/mdtu-ddm/low-code-platform/platform/backend/applications/digital-signature-ops[digital-signature-ops]
|Підсистема що забезпечує операції по роботі з цифровим підписом в реєстрі
