...
Також, підсистема підтримує журналювання вхідних запитів та збір метрик продуктивності
для подальшого аналізу через вебінтерфейси відповідних підсистем Платформи.
