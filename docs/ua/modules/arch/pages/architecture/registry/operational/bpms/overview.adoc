...
[WARNING]
--
Події не реалізовано
--

|===
|Тип події|Службова назва|Опис

|_USER_EVENT_|NEW_TASK_SAVED|Нова задача збережена
|_USER_EVENT_|TASK_UPDATED|Існуючу задачу було змінено
|_USER_EVENT_|NEW_PROCESS_SAVED|Новий процес збережено
|_USER_EVENT_|PROCESS_UPDATED|Існуючий процес було змінено
|===
