...
|Сервіс, який надає _REST API_ для управління бізнес-процесами та виконанням задач через кабінети користувачів, виконує оркестрацію виконання запитів, надає _REST API_ для доступу до історичних даних виконання бізнес-процесів та задач
