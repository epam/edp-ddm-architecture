...
== Загальний опис
Розробка регламенту реєстру включає розробку моделі даних реєстру. Адміністративний портал надає функціонал по перегляду моделі даних реєстру. Необхідно забезпечити можливість редагування моделі даних регламенту реєстру.

== Опис проблеми
Адмін портал має функціональність по перегляду стану моделі даних регламенту реєстру. Наявний підхід передбачає внесення змін у Gerrit до відповідного MR версії-кандидату під час розробки моделі даних регламенту реєстру.
