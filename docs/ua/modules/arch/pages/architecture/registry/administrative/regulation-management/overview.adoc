...
* REST API для роботи з версіями регламенту реєстру та його складовими
* функціональність підказок, автодоповнення функцій та перевірки при редагуванні коду у
_Вебінтерфейсі моделювання регламенту_
* REST API доступ для експорту звітів з _Вебінтерфейсу моделювання звітів_
