...
|`<<registryIdGovUa,registryIdGovUa>>`
|bool
|❌
|✅
|
...
|❌
|✅
|Визначає шлях до автентифікаційного токена в _Сервісі управління секретами та шифруванням_ Hashicorp Vault.
...
|❌
|✅
|Визначає можливість самореєстрації користувачів в реєстрі, при наявності попередньо змодельованого бізнес-процесу самореєстрації.
