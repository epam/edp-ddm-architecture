...
[[yaml]]
У цьому розділі наведено список загальних параметрів налаштувань Платформи, що налаштовуються адміністраторами через адмін-консоль або прямий коміт в репозиторій.
...
`keycloak` містить налаштування сервісу управління користувачами та ролями Keycloak.
...
`keycloak.customHosts` містить перелік альтернативних DNS-імен для Keycloak.

[[customHosts]]
[cols="20%,15%,7%,7%,60%",options="header",caption=]
.keycloak | <<parent-keycloak,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[[child-customHosts]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.customHosts | <<customHosts,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[[backup]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.velero | <<parent-velero,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.backup | <<backup,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[[backup-params]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.backup params | <<backup-control-plane,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[[global]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.global | <<parent-global,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[[console-versions]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.consoleVersions | <<parent-global,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
|===
|Поле|Тип|Обовʼязкове|Призначення
...
|❌
|✅
|Містить назву `StorageClass` що використувається в кластерів OKD за замовчуванням.
