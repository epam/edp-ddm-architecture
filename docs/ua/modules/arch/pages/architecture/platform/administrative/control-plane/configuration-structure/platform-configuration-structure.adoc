...
[[global]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.Загальні параметри Платформи | <<parent-global,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
...
[[whitelistip]]
[cols="20%,10%,5%,5%,60%",options="header",caption=]
.Параметри налаштування доступу до роутів адміністративних сервісів Платформи | <<global,Повернутись на батьківську таблицю>>
|===
|Поле|Тип|Значення за замовчуванням|Обовʼязкове|Призначення
