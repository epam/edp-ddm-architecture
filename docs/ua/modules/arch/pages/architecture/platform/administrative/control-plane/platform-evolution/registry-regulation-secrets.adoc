...
|===
|Назва компонента|Рівень|Зовнішня система/Реєстр|Конфігурація|Спосіб інтеграції|Сценарій
...
=== Налаштування автентифікатора отримувачів послуг

В рамках автентифікації отримувачів послуг, система отримує дані користувача з ЄДР. Конфігурація інтеграції та секрет зберігаються на рівні регламенту та застосовуються _Пайплайном публікації регламенту_ для налаштування _dso-citizen-authenticator_ реєстру:
