...
|Сховище тимчасового зберігання цифрових документів, завантажених в рамках виконання БП

|_datafactory-ceph-bucket_
|xref:arch:architecture/registry/operational/registry-management/overview.adoc[]
|Сховище зберігання підписаних цифрових документів реєстру

|_file-excerpt-bucket_
|xref:arch:architecture/registry/operational/excerpts/overview.adoc[]
|Сховище зберігання згенерованих та підписаних витягів з реєстру
