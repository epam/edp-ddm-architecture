...
[NOTE]
_Платформа реєстрів_ є програмним комплексом з відкритим кодом, який розповсюджується за ліцензією https://www.apache.org/licenses/LICENSE-2.0[Apache License v2.0].
