...
|[[ext-secrets-operator]]https://github.com/stakater[Reloader]|1.0.25|https://www.apache.org/licenses/LICENSE-2.0[APACHE LICENSE, v2.0]|Operator для спостереження за змінами в ConfigMap та Secrets та виконання оновлень на подах компонентів реєстра без переривання їх роботи.
|===
