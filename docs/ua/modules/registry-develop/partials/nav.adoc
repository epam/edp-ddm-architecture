...
**** xref:registry-develop:registry-admin/timeouts/set-timeout-bpms-rest-api.adoc[]
**** xref:registry-develop:registry-admin/timeouts/set-timeout-redash-kong-webapp.adoc[]
+
// ======================= DATA MODELING ======================================
...
include::registry-develop:partial$audit/registry-audit/nav.adoc[]
+
// ================ АУДИТ КОНФІГУРАЦІЇ РЕСУРСІВ РЕЄСТРУ ================
include::registry-develop:partial$audit/registry-config-audit/nav.adoc[]