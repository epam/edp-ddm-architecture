...
+
*** xref:registry-develop:registry-admin/cp-deploy-global-registry-demo-regulation.adoc[]
+
...
**** xref:registry-develop:registry-admin/openshift-logging/kibana-audit.adoc[]
...
*** xref:registry-develop:registry-admin/registry-min-config.adoc[]
+
// ===================== deploymentMode ========================
+
...
******* xref:registry-develop:registry-admin/external-integration/api-call/trembita/search-subjects.adoc[]
******* xref:registry-develop:registry-admin/external-integration/api-call/trembita/subject-detail.adoc[]
******* xref:registry-develop:registry-admin/external-integration/api-call/trembita/get-cert-by-num-role-names.adoc[]
******* xref:registry-develop:registry-admin/external-integration/api-call/trembita/get-cert-by-num-role-birth-date.adoc[]
******* xref:registry-develop:registry-admin/external-integration/api-call/trembita/id-pexchange-service.adoc[]
...
***** xref:registry-develop:registry-admin/external-integration/cp-integrate-payment/cp-integrate-stripe-ext-system.adoc[Налаштування інтеграції з платіжною системою Stripe]
...
***** xref:registry-develop:registry-admin/external-integration/api-publish/rest-soap-api-expose-file-content.adoc[]
// ==================== WIREMOCK ====================
**** xref:registry-develop:registry-admin/external-integration/cp-mock-integrations.adoc[]
// ==================== CHECK INTEGRATION POSTMAN ====================
**** xref:registry-develop:registry-admin/external-integration/postman-check-integration.adoc[]
+
// API Rate Limits
*** API рейт-лімітування
...
// ===================== Form deletion instruction ========================
+
*** xref:registry-develop:registry-admin/form-deletion.adoc[]
+
...
**** xref:registry-develop:bp-modeling/forms/cards/registry-data-view-as-cards.adoc[]
...
****** xref:registry-develop:bp-modeling/forms/components/general/logic-conditions.adoc[]
...
***** xref:registry-develop:bp-modeling/forms/components/code.adoc[Code]
...
****** xref:registry-develop:bp-modeling/forms/components/button/display/action/save-data.adoc[]
***** Map
