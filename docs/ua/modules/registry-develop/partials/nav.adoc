...
***** xref:registry-develop:registry-admin/cp-auth-setup/officers/enable-single-identity.adoc[]
**** Отримувачі послуг
...
****** xref:registry-develop:registry-admin/external-integration/api-call/trembita/overview.adoc[Інтеграція з "Трембіта": SOAP API контракт (XML)]
...
******* xref:registry-develop:registry-admin/external-integration/api-call/trembita/idp-exchange-service.adoc[]
...
*** xref:registry-develop:bp-modeling/bp/index.adoc[Моделювання бізнес-процесів]
...
+
// ========================== МОДЕЛЮВАННЯ ФОРМ БІЗНЕС-ПРОЦЕСІВ ==========================
...
** xref:registry-develop:registry-audit-instruction/registry-audit-instruction.adoc[Аудит регламенту реєстру]
...
*** xref:registry-develop:registry-audit-instruction/modules/general-audit.adoc[Загальні рекомендації]