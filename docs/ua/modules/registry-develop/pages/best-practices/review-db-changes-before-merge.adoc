...
.. Перейдіть до розділу +++<b style="font-weight: 600;">Таблиці<b>+++ та відкрийте +++<b style="font-weight: 600;">Файл опису структури<b>+++.
+
...
.. В адміністративному порталі перейдіть на +++<b style="font-weight: 600;">Огляд версії<b>+++.
