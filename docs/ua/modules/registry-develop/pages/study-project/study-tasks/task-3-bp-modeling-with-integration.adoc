...
. xref:bp-modeling/bp/element-templates/element-templates-install.adoc[Встановіть додаток Camunda Modeler і типові розширення до нього].
. xref:registry-develop:bp-modeling/forms/components/index.adoc[Ознайомтеся із компонентами для моделювання форм].
...
//. xref:registry-develop:bp-modeling/bp/bpmn/subprocesses/call-activities.adoc[Ознайомтеся з логікою роботи Call Activity].
