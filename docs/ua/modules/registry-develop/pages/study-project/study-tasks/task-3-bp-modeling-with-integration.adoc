...
Для підпису використовується делегат xref:bp-modeling/bp/element-templates/service-task-templates/signature/system-signature-by-dso-service.adoc[System signature by DSO service], який забезпечує підписання даних із використанням внутрішнього ключа системи.
...
Template ::
Використовуйте інтеграційне розширення (делегат) xref:bp-modeling/bp/element-templates/service-task-templates/signature/system-signature-by-dso-service.adoc[System signature by DSO service].
