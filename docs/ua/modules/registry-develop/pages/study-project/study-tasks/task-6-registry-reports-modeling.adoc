...
=====
+
image:registry-develop:study-project/task-6/dashboard-naming/dashnoard-naming-2-ua.png[]
...
----
+
image:registry-develop:study-project/task-6/dashboard-naming/dashnoard-naming-3-ua.png[]
