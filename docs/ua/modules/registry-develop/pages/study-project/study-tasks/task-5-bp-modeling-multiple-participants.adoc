...
.У рамках цього завдання моделювальники мають:
[%interactive]
...
. Скопіюйте форму xref:#form-sign-data-by-citizen[Підписання даних про лабораторію], змодельовану вище, натиснувши _іконку копіювання_ -- це дозволить створити форму із готового шаблону:
