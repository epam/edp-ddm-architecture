...
. Відкрийте консоль адміністратора *Control Plane* > перейдіть на пункт меню +++<b>PLATFORM MANAGEMENT</b> > далі вкладка <b>QUICK LINKS</b>+++ та перейдіть за посиланням до центрального компонента *Gerrit*.
+
...
. Відкрийте консоль адміністратора *Control Plane* > перейдіть на пункт меню +++<b>REGISTRIES</b>  далі вкладка <b>QUICK LINKS</b>+++ та перейдіть за посиланням до реєстрового компонента *Gerrit*.
+
