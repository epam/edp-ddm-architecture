= Сервіс отримання даних Свідоцтва про народження (_GetCertByNumRoleNames_)
...
|ResultCode|Результат запита|string|необов'язково
|ResultData|XML з вихідними даними згідно з форматом у документі та з набором заданих полів у Base64|string|необов'язково
|====
...
* xref:registry-develop:bp-modeling/bp/element-templates/soap-integration/dracs/get-certificate-by-name.adoc[SOAP-конектор _Get Certificate By Name_]