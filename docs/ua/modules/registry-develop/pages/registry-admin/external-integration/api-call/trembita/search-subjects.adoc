...
* xref:registry-develop:bp-modeling/external-integration/api-call/connectors-external-registry.adoc#search-subjects-edr-registry[Отримання інформації за суб'єктом в ЄДР]