...
.Налаштування external-systems у файлі ext-integrations/outbound.yml для версій реєстру 1.9.3+
=====
[source, yaml]
----
...
Для цього потрібно налаштувати параметри блоку `*external-systems*` у конфігураційному файлі *_ext-integrations/outbound.yml_* відповідного реєстру.
