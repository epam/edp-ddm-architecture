...
|+++<p style="background-color: #ffe6e6;">Deprecated<p/>+++
|xref:bp-modeling/bp/element-templates/service-task-templates/users/search-registry-users.adoc[]
...
|xref:bp-modeling/bp/element-templates/service-task-templates/search-registry-users-by-attributes.adoc[]
|`searchRegistryUsersByAttributes`
|+++<p style="background-color: #ff4d4d;">Deprecated<p/>+++
|xref:bp-modeling/bp/element-templates/service-task-templates/users/search-registry-users.adoc[]
