...
[IMPORTANT]
====
Ця сторінка застаріла і незабаром буде видалена.
Актуальні інструкції доступні у розділі
xref:registry-develop:bp-modeling/bp/element-templates/element-templates-overview.adoc[Інтеграційні розширення бізнес-процесів].
====
