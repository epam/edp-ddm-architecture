...
Виконайте локальні налаштування (за потреби). Зверніться до документа xref:bp-modeling/bp/element-templates/element-templates-install.adoc[] за більш детальною інформацією.
