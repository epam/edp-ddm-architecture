...
* Поле головної таблиці, що містить ключі посилання на підпорядковану таблицю (`referenceKeysArray`) має **обов'язково** посилатися на ідентифікатори та бути масивом.
====
