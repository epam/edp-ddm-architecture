...
. Якщо документ має розділ +++<b style="font-weight: 600">Підготовка реєстру до оновлення</b>+++, виконайте цю частину інструкцій.
+
...
. Відкрийте відомості про тестовий реєстр і знайдіть розділ +++<b style="font-weight: 600">Запити на оновлення</b>+++.
...
. Якщо документ має розділ +++<b style="font-weight: 600">Кроки після оновлення реєстру</b>+++, виконайте цю частину інструкцій.
+
