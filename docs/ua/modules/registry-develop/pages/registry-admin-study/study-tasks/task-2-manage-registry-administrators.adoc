...
+++<b style="font-weight: 600">Адміністративна зона Платформи >
Сервіс розгортання конфігурації<b>+++ (Jenkins).

* У розділі +++<b style="font-weight: 600">Інформація про реєстр >
Конфігурація<b>+++ > *CI*.
+
