...
+++<b style="font-weight: 600">Адміністративна зона Платформи</b>+++ >
+++<b style="font-weight: 600">Сервіс розгортання конфігурації (Jenkins)</b>+++.

* У розділі +++<b style="font-weight: 600">Інформація про реєстр</b>+++ >
+++<b style="font-weight: 600">Конфігурація</b>+++ > *CI*.
+
...
+++<b style="font-weight: 600">Адміністративна зона реєстру</b>+++ > +++<b style="font-weight: 600">Вебінтерфейс управління виконанням бізнес-процесів (Business Process Administration Portal)</b>+++.
...
====
* Ви можете знайти посилання на інтерфейс у розділі швидких посилань *Control Plane*: +
+++<b style="font-weight: 600">Операційна зона Платформи</b>+++ > +++<b style="font-weight: 600">Сервіс управління користувачами та ролями (Keycloak)</b>+++.
...
Наприклад, +++<b style="font-weight: 600">Вебінтерфейс моделювання регламенту (Admin Portal)</b>+++.
...
. Перейдіть до Jenkins за посиланням у розділі +++<b style="font-weight: 600">Інформація про реєстр</b>+++ > +++<b style="font-weight: 600">Конфігурація</b>+++ > стовпець *CI*.
+
...
.. Відкрийте тестовий реєстр та зайдіть у розділ +++<b style="font-weight: 600">Інформація про реєстр</b>+++ > +++<b style="font-weight: 600">Загальна інформація</b>+++.
