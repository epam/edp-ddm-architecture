...
NOTE: Деякі ключі, особливо тестові, можуть не працювати із включеним `istio`, тому необхідно вимкнути `sidecar`-контейнер `istio` для поду криптосервісу `digital-signature-ops`.
