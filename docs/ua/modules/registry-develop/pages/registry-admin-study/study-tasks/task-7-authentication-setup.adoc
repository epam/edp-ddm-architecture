...
* +++<b style="font-weight: 600">Ключ:</b>+++ _Key-6.day_ із папки _Юридична особа (з посадою)_ із попередньо завантаженого архіву (_див. розділ xref:#prerequisites[], крок 1_);
