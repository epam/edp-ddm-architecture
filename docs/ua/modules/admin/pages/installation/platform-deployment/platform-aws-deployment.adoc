...
* [*] Документ xref:release-notes:breaking-changes.adoc[Зворотно несумісні зміни];
...
. Завантажте OKD інсталер з офіціального GitHub репозиторію.
+
[source,bash]
----
