...
У разі необхідності розгортання платформи з нуля в _GCP_-середовищі, рекомендовано скористатись офіційною документацією _OpenShift_ та _Платформи Реєстрів_ на прикладі _AWS_ хмарного середовища:
