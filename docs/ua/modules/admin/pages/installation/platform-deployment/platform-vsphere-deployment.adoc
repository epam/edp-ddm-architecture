...
Перед запуском скрипка з інсталювання Платформи необхідно виконати наступні кроки:

* Завантажте Інсталер відповідної версії та порівняйте чексуми, щоб упевнитися, що Інсталер завантажився коректно:
