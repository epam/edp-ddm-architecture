...
[options="header", cols="10%,30%,50%,10%"]
|===
|Логотип |Назва сервісу |Призначення |Посилання
...
|Сховище артефактів Платформи (Control Plane Nexus)
...
|Сервіс управління секретами та шифруванням (Vault)
...
|image:infrastructure/cluster-mgmt/quick-links/logos/vault-logo.svg[width=50,height=auto]
|Центральний сервіс управління секретами Платформи (Vault)
