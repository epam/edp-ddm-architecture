...
* [*] *Seeking learning opportunities* and want to know more and gain some practical skills? Visit the following:
...
* [*] *For service providers, government officers, service recipients, and citizens*: Engaging with the user portal as part of business processes? Your portal awaits: xref:user:overview.adoc[User documentation].
