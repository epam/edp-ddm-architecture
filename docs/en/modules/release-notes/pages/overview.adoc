...
* [*] xref:release-notes:breaking-changes.adoc[Breaking changes] -- This page focuses on the most critical changes to the Platform functionality that are backward incompatible.
