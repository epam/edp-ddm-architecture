...
This component of the regulations is responsible for setting up templates for sending informational messages to registry users. It is represented as two directories, taking into account the communication channels supported by the _Platform for state registries_:
