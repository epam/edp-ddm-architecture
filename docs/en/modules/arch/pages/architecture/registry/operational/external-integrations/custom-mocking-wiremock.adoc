...
image::architecture/registry/operational/external-integrations/mocking/current-mocking-solution.svg[]
...
image::architecture/registry/operational/external-integrations/mocking/enable-mocking-flow.svg[enable-mocking]

Важливо відзначити, що після збереження конфігурації відбувається виконнаня флоу яке описане в рамках дизайну xref:architecture-workspace/platform-evolution/registry-regulation-secrets.adoc#_технічний_дизайн_рішення[Управління налаштуваннями та секретами зовнішніх інтеграцій] з врахуванням наступних ремарок:
...
----
include::partial$architecture/registry/operational/external-integrations/mocking/enable-mocking-for-registry.puml[enable-mocking-flow, align="center"]
----
...
image::architecture/registry/operational/external-integrations/mocking/mock_trembita.png[registry-integrations-management, 200, align="center"]

.Налаштування взаємодії з моком інтеграційних точок Трембіта для dev реєстру
image::architecture/registry/operational/external-integrations/mocking/enable_mock_trembita.png[registry-integrations-management, 200, align="center"]

.[#external-system]#Налаштування взаємодії реєстру з зовнішньою системою#
image::architecture/registry/operational/external-integrations/mocking/mock_rest_system.png[registry-integrations-management, 200, align="center"]

.Налаштування взаємодії реєстру з моком інтеграційних точок зовнішніх систем
image::architecture/registry/operational/external-integrations/mocking/enable_mock_rest_system.png[registry-integrations-management, 200, align="center"]
...
image::architecture/registry/operational/external-integrations/mocking/import-mapping-flow.svg[align="center"]

.Додавання власного моку для використання у реєстрі
[plantuml,import-user-mocking-flow, svg]
----
include::partial$architecture/registry/operational/external-integrations/mocking/import-user-mock.puml[import-user-mocking-flow, align="center"]
----
...
image::architecture/registry/operational/external-integrations/mocking/mock-api.png[align="center", 500, 500]

* Обрати пустий шаблон та заповнити назву

image::architecture/registry/operational/external-integrations/mocking/create-new-mock.png[align="center", 500, 500]

* Перейти до вкладки Stubs

image::architecture/registry/operational/external-integrations/mocking/stubs.png[align="center", 500, 500]

* Натиснути кнопку New

image::architecture/registry/operational/external-integrations/mocking/new-stub.png[align="center", 500, 500]

* Заповнити налаштування мапінгу та зберегти його

image::architecture/registry/operational/external-integrations/mocking/save-stub.png[align="center", 500, 500]

* Експортувати файл для завантаження його у реєстровий герріт

image::architecture/registry/operational/external-integrations/mocking/export-mock.png[align="center", 500, 500]
