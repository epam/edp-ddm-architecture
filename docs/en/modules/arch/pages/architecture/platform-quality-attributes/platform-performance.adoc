...
_This attribute defines the capability of a system to process any request within a restricted time interval, and provide the processing of the required number of requests in the set time interval without an increase in the time defined for their processing._
