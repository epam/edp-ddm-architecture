...
You can find detailed information on performance testing in the corresponding sections:
...
* xref:testing:performance-testing/perf-report/1-9-5/perf-test-1-9-5-1500-8.adoc[Platform version 1.9.5 testing with 1500 users for 8 hours workload]
