...
_This attribute defines the capability of a system to protect data and information from unauthorized access, providing access to authorized users and systems at the same time._

//Архітектура безпеки _Платформи Реєстрів_ відповідає за три загальноприйняті характеристики:
The _Registry Platform_ security architecture is responsible for the three general characteristics:
