...
More details regarding the roles of service administrators can be found in the xref:arch:architecture/platform/operational/user-management/platform-actors-roles.adoc#службові_адміністратори[Actors and roles of the Platform] section.
--

//== Технічний дизайн операційної зони Платформи
== Technical design of the Platform operational zone
