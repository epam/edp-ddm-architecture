...
== Responsibilities and requirements for the registry administrator position
...
=== Configuration of digital signature keys and certificates
...
=== Registry component access restrictions (CIDR)
...
=== Digital document upload restrictions management
