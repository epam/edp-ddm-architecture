...
* *`platform`*: provides access to the registry's VIEWs and REST API for another registry on the Platform.
* *`externalSystem`*: provides access to the registry's VIEWs and REST API for an external system.
* *`trembita`*: provides access to the registry's VIEWs and SOAP API for external systems/registries via the "Trembita" Secure exchange gateway.
+
