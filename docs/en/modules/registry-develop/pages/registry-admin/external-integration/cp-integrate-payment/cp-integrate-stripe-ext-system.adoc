...
* *External system name*: Enter the name of the payment system to integrate with. For example, `stripe` .
+
[CAUTION]
====
...
====
* *External system address*: Enter the base URL of the payment server to connect to - `https://api.stripe.com`.
+
[NOTE]
====
...
These settings are automatically added to the YAML configuration of the Service Entry.
====
+
