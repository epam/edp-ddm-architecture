...
*** Integration with external registries and systems
...
****** xref:registry-develop:bp-modeling/bp/rest-connector.adoc#regulations-configuration[Integration with external services using the REST connector: configuring the regulations]
...
** xref:registry-develop:data-modeling/index.adoc[]
+
...
**** xref:registry-develop:data-modeling/initial-load/data-initial-data-load-prep.adoc[]
...
*** xref:registry-develop:bp-modeling/bp/index.adoc[]
...
***** xref:bp-modeling/bp/element-templates/service-task-templates/keycloak-get-officer-users-by-attributes-equals-start-with.adoc[]
...
**** Limiting access to business processes and tasks
...
*** Business process examples for reference
